...
class Transfer4 extends StatefulWidget {
  const Transfer4({super.key});

  @override
  State<Transfer4> createState() => _HomepageState();
}

class _HomepageState extends State<Transfer4> {
...
SizedBox(height: 200,),
InkWell(onTap: () {
  Navigator.push(context, MaterialPageRoute(builder: (context) => Transfer5()));
},
